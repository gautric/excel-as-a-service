...
import net.a.g.excel.load.cdi.ExcelLoaderImpl;
...
import net.a.g.excel.repository.cdi.ExcelRepositoryImpl;
...
public class EngineTest {
	...
	public void setup() {
		...
		try {
			assertTrue(loader.injectResource("KYC", "KYC.xlsx",
					FileUtils.openInputStream(new File("./src/test/resources/KYC.xlsx"))));
		} catch (IOException e) {
			e.printStackTrace();
		}
